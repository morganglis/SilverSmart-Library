...
def seed_database():
    ...
    authors = [
        ...
        Author(authorID=16, firstName='Forbes Media', lastName='Publishing'),
        Author(authorID=17, firstName='Conde Nast', lastName='Publishing'),
        Author(authorID=18, firstName='Meredith Corporation', lastName='Publishing'),
        Author(authorID=19, firstName='Mario', lastName='Puzo'),
        Author(authorID=20, firstName='Michael', lastName='Curtiz'),
        Author(authorID=21, firstName='Robert', lastName='Wise'),
        Author(authorID=22, firstName='Lana', lastName='Wachowski'),
        Author(authorID=23, firstName='Matt', lastName='Reeves'),
        Author(authorID=24, firstName='Christopher', lastName='McQuarrie'),
        Author(authorID=25, firstName='John', lastName='Satzinger'),
        Author(authorID=26, firstName='Andrew', lastName='Stellman'),
        Author(authorID=27, firstName='Gary', lastName='Spurrier'),
    ]
    ...
    item_authors = [
        ...
        ItemAuthors(authorID=16, itemID=16),
        ItemAuthors(authorID=17, itemID=17),
        ItemAuthors(authorID=18, itemID=18),
        ItemAuthors(authorID=19, itemID=19),
        ItemAuthors(authorID=20, itemID=20),
        ItemAuthors(authorID=21, itemID=21),
        ItemAuthors(authorID=22, itemID=22),
        ItemAuthors(authorID=23, itemID=23),
        ItemAuthors(authorID=24, itemID=24),
        ItemAuthors(authorID=25, itemID=25),
        ItemAuthors(authorID=26, itemID=26),
        ItemAuthors(authorID=27, itemID=27),
    ]
